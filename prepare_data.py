...
if __name__ == "__main__":
    prepare(
        "./data/tuyen_sinh/ke_hoach_trien_khai_cong_tac_tuyen_sinh_dh_2024.docx",
        "./datapickle/ke_hoach_trien_khai_cong_tac_tuyen_sinh_dh_2024.pkl",
    )
    prepare(
        "./data/tuyen_sinh/QHI_Đề án TS ĐHCQ năm 2024 (Điều chỉnh).docx",
        "./datapickle/QHI_Đề án TS ĐHCQ năm 2024 (Điều chỉnh).pkl",
    )
    prepare(
        "./data/tuyen_sinh/Quyết định ban hành Quy chế tuyển sinh đại học chính quy tại ĐHQGHN (trình ký).docx",
        "./datapickle/Quyết định ban hành Quy chế tuyển sinh đại học chính quy tại ĐHQGHN (trình ký).pkl",
    )
